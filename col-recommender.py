...
merged_sub= merged[merged.user_id <= 100]
merged_sub.head()
...
def top_animes(anime_name):
    ...
    for item in item_sim_df.sort_values(by = anime_name, ascending = False).index[1:6]:
...
# for i in watched:
#     actual=piv.loc[3, i]
#     predicted = predicted_rating('Cowboy Bebop', 3)
